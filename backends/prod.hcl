...
key            = "prod/infra.tfstate"  // Escribe la ruta y el nombre del archivo de estado de Terraform dentro del bucket de S3 (puedes cambiar "prod/infra.tfstate" por la ruta y el nombre que prefieras)
